    ...
    if (platform === "kick") {
        chatContainer.innerHTML = `
                <div style="position:relative;height:100%;overflow:hidden;">
                    ...
                    <div style="position:absolute;bottom:0;left:0;right:0;height:83px;background:#0e0e10;border-top:1px solid var(--border);display:flex;align-items:center;justify-content:center;z-index:5;">
